...
<div class="row50">
	...
	<p>
	<div class="f_left tb_name">父级菜单名称:</div>
...
<div class="row50">
	...
	<div class="f_left tb_value">
		<input class="text validate" type="text" name="menu_name"
			isrequired="yes" tipmsg="菜单名称" maxlength="60" maxdatalength="60"
		...
		<select class="validate" name="target" isrequired="yes" type="select"
 		...
 		<div class="row50">
 			<p>
 				...
 				<div  class="f_left tb_value">
 					<input class="text validate sort_no" name="sort_no" type="text" isrequired="yes" widthtip="100" 

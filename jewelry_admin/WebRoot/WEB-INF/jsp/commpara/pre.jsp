...
<body>
	<form action="/admin/commpara/pre" method="post">
		<div class="list_oper_div">
			<input class="btn ol_btn" type="button" value="新增分类"
				onclick="addInfo('/admin/commpara/preadd');" />
			<input
					class="btn ol_btn" type="button" value="排序"
					onclick="sortInfo('/admin/commpara/presort');" />
		</div>
		<div class="searchDiv">
			<table class="searchTable">
				<tr>
	  	  		...
	  	  		<td>
	  	  			<input class="btn ol_colorbtn ol_greenbtn" type="button" value="查询" onclick="goInfo('/admin/commpara/pre');"/>
		  	  		<input class="btn ol_colorbtn ol_bredbtn" type="button" value="清空" onclick="clearSearch('/admin/commpara/pre');"/>
	  	  		</td>
  	  		 </tr>
  	  		 </table>
  	  </div>	
	  				...
	  				<c:forEach items="${commparaList}" var="item" varStatus="status">
	  					<tr>
		  					...
		  					<td>
		  						...
		  						<input class="btn ol_colorbtn ol_bluebtn" type="button" value="修改" onclick="goInfo('/admin/commpara/preedit','${item.para_id}');"/>
		  						<input class="btn ol_colorbtn ol_redbtn" type="button" value="删除" onclick="delInfo('/admin/commpara/preDelete','${item.para_id}');"/>
		  					</td>
	  					</tr>
	  				</c:forEach>
	  			</c:if>
	  ...
	  <div class="batchDiv">
	  		...
	  		<input class="btn ol_colorbtn ol_redbtn" type="button" value="批量删除" onclick="commonBatchInfo('/admin/commpara/preBatchDelete','确定删除字典？');"/>
	  </div>

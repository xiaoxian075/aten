    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="dataTables_length" id="dataTables-example_length">
                <label>
                    <input type="search" class="form-control input-sm" placeholder="资质" aria-controls="dataTables-example" id="title" value=""/>
                </label>
                <label>
                    <input type="search" class="form-control input-sm" placeholder="备注" aria-controls="dataTables-example" id="note" value=""/>
                </label>
...
<script>
    $(function () {
        ...
        var table = $.attractMerchantsHZ.initTables("user-table", null);
    ...
    function del(id){
        if (confirm("确定要删除数据吗?删除后将无法还原。")) {
            $.ajax({
                url: "<%=basePath%>rest/admin/attractMerchants/hz/delete",
                data: {id:id},
                type: "post",
                dataType: "json",

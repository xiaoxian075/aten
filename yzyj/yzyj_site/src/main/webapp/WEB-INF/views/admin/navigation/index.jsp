    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="dataTables_length" id="dataTables-example_length">
                ...
                <a href="javascript:void(0)" class="btn btn-sm btn-success" id="add"><i  class="icon-plus"></i> 新增</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    $(function () {
        ...
        var table = $.navigationinfo.initTables("user-table", null);
    ...
    function editAdvert(id,state){
        ...
        if (r) {
            $.ajax({
                type: "POST",
                url: "<%=basePath%>rest/admin/navigation/editNavigation",
                traditional: true,
    ...
    function del(id){
        if (confirm("确定要删除数据吗?删除后将无法还原。")) {
            $.ajax({
                url: "<%=basePath%>rest/admin/navigation/delete",
                data: {id:id},
                type: "post",
                dataType: "json",

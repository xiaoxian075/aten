...
<div class="detail_img_list" style="border:1px solid red;width:300px;height:200px;" >
	 <img class="img_height120 separate" id="img_${one_img_name}" 
	  ...
	  />	
	  <input  type="hidden" class="validate" changetip="${one_img_name}_div"  id="hidden_${one_img_name}"
	  			 isrequired="yes"  name="${one_img_name}" value="${one_img_url}"/>  
	  ...
	  <div id="${one_img_name}_div" setwidth="200" setheight="25" tipmsg="${one_img_tip}" >
		  	<table><tr>
		  		...
		  		<td><img class="cancel" src="/include/admin/image/cancel.png" onclick="cancelImg('${one_img_name}');"/></td>
		  	</tr></table>
	  </div>

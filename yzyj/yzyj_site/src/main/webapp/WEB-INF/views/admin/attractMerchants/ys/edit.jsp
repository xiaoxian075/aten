...
<div class="modal-content" id="brand-content">
    ...
    <div class="modal-body">
        <form class="form-horizontal" role="form" id="editForm" method="POST" enctype="multipart/form-data" action="<%=basePath%>rest/admin/attractMerchants/ys/edit">
            <c:choose>
                <c:when test="${not empty info.id}">
            ...
            <div class="form-group" id="mcDiv">
                <div class="group">
                    <label class="col-sm-3 control-label">亮点</label>
                    <div class="col-sm-9">

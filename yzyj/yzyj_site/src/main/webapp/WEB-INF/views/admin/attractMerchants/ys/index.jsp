    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="dataTables_length" id="dataTables-example_length">
                <label>
                    <input type="search" class="form-control input-sm" placeholder="亮点" aria-controls="dataTables-example" id="title" value=""/>
                </label>
                <label>
                    <input type="search" class="form-control input-sm" placeholder="说明" aria-controls="dataTables-example" id="note" value=""/>
                </label>
...
<script>
    $(function () {
        ...
        var table = $.attractMerchantsYS.initTables("user-table", null);
    ...
    function edit(id) {
        $.ajax({
            type: "GET",
            url: "<%=basePath%>rest/admin/attractMerchants/ys/edit",
            traditional: true,
            data:{id:id},
            dataType: "html",
            cache: false,
    ...
    function del(id){
        if (confirm("确定要删除数据吗?删除后将无法还原。")) {
            $.ajax({
                url: "<%=basePath%>rest/admin/attractMerchants/ys/delete",
                data: {id:id},
                type: "post",
                dataType: "json",

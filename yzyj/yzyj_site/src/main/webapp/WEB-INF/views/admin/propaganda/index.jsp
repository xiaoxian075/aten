    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="dataTables_length" id="dataTables-example_length">
                <label>
                    <input type="search" class="form-control input-sm" placeholder="视频标题" aria-controls="dataTables-example"   name="title" value=""/>
                </label>
...
<script>
    $(function () {
        ...
        var table = $.propagandainfo.initTables("user-table", null);
    ...
    $("#add").click(function(){
        $.ajax({
            type: "GET",
            url: "<%=basePath%>rest/admin/propaganda/edit",
            traditional: true,
            dataType: "html",
            cache: false,
    ...
    function del(id){
        ...
        var content= "是否删除该视频？删除后无法还原"
        var r = confirm(content);
        if (r) {
            $.ajax({
                type: "POST",
                url: "<%=basePath%>rest/admin/propaganda/delete",
                traditional: true,
                data: {id: id},
                dataType: "json",
                cache: false,

    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="dataTables_length" id="dataTables-example_length">
                ...
                <%--</label>--%>
                <%--<label>--%>
                    <%--<span style="width:200px;">动态类型</span><select class="form-control input-sm" id="type"  >--%>
                        <%--<option value="">请选择</option>--%>
                        <%--<c:forEach items="${dynamic_info_type}" var="ls">--%>
...
<script>
    $(function () {
        ...
        var table = $.serviceInfo.initTables("user-table", null);
    ...
    function edit(id) {
        window.location.href="<%=basePath%>rest/admin/service/edit?id="+id;
    }
    function del(id){
        if (confirm("确定要删除数据吗?删除后将无法还原。")) {
            $.ajax({
                url: "<%=basePath%>rest/admin/service/delete",
                data: {id:id},
                type: "post",
                dataType: "json",

...
<div class="row" style="width:100%;height:100%">
    <div class="col-xs-12">
        <div class="box">
            <div class="box-body" >
                <form class="form-horizontal" role="form" id="editForm" method="POST" enctype="multipart/form-data" action="<%=basePath%>rest/admin/plan/edit">
                        ...
                        <c:if test="${not empty info.logo}">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3" style="width:200px;height:100px">
                                    <img src="<%=basePath%>upload/plan/${info.logo}" style="height:100%;width:100%" />
                                </div>
                            </div>
                        </c:if>
                        <div class="form-group">

 ...
 */
@Controller
@RequestMapping(value = "/admin/attractMerchants/ys")
public class AttractMerchantsYSController extends BaseController {
    @Resource
    ...
    public String index(Model model) {
        return "admin/attractMerchants/ys/index";
    }
    ...
    public String edit(Model model, AttractMerchants attractMerchants) {
        ...
        return "admin/attractMerchants/ys/edit";
    }

...
public class DesUtil {
	...
	public static void main(String[] args) throws Exception {
		System.out.println(encrypt("yffs_site", "12345678"));
		System.out.println(encrypt("gEDjKF84RGstxa4v", "12345678"));
		System.out.println(encrypt("jdbc:oracle:thin:@10.28.237.143:1521:yunpay", "12345678"));
////		System.out.println(encrypt("sa", "12345678"));
////		System.out.println(encrypt("passpass", "12345678"));
//		System.out.println(decrypt("gjdiMhGdMAgjO6zz++4PlfF+kurd8ALCVFJ6EY4sE5z9j5gCx31YS03sMD1Ld2BE", "12345678"));
//		System.out.println(decrypt("HgFuNMDUezA=", "12345678"));
//		System.out.println(decrypt("3ay57mOfp+s=", "12345678"));

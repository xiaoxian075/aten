...
public class Sign {
 ...
 /*   public static void main(String[] args) {
    ...
    public static String getAccessToken() {  
        ...
        String AppId="wx5fe80cfcbe876523";//第三方用户唯一凭证
        String secret="6aceae561ee38b7a87cf53814b9eb14e";//第三方用户唯一凭证密钥，即appsecret
        //这个url链接地址和参数皆不能变  
...
//    }
    ...
    public static HashMap<String, String> getSign(String url){
        ...
        */  
        ...
        String ss = "accessToken:"+accessToken+"\njsapi_ticket:"+jsapi_ticket+"\ntimestamp："+timestamp+"\nnoncestr："+noncestr;

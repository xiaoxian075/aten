package com.admin.service.impl; import com.admin.dao.RoleDaoMapper; import com.admin.model.*; import com.admin.service.RoleService; import com.core.generic.GenericDao; import com.core.generic.GenericServiceImpl; import com.core.mybatis.DataTablesPage; import org.springframework.stereotype.Service; import org.springframework.util.StringUtils; import javax.annotation.Resource; import java.util.Arrays; import java.util.List; /** Created by Administrator on 2016/3/24. */ @Service public class RoleServiceImpl extends GenericServiceImpl<Role, String> implements RoleService { @Resource private RoleDaoMapper roleDaoMapper; /** 根据角色查询权限 @return */ public List<Menu> selectMenuByroleId(String roleId){ return null; } @Override public GenericDao<Role, String> getDao() { return roleDaoMapper; }

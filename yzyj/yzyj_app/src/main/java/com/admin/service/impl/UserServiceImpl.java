...
public class UserServiceImpl extends GenericServiceImpl<User, String> implements UserService {
    ...
    public User selectAgentByUserName(String username){
        return userDaoMapper.selectAgentByUserName(username);
    }
    /**
     * 查找用户的功能菜单
     * @param id
   ...
   public java.util.HashMap selectUserMenu(String id){
       ...
       String handleModule = "";
           for (Menu menu : menuList) {
               ...
               handleModule += menu.getHandleModule()+"#";
    ...
    public User selectToken(String token){
        return userDaoMapper.selectToken(token);
    }

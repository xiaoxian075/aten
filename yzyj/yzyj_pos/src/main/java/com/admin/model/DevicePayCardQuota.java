...
public class DevicePayCardQuota {
    ...
    private Integer cxkExcessOne;    //储蓄卡超额单笔
    private Integer cxkExcessDay;    //储蓄卡超额单日
    private Integer cxkExcessMonth;    //储蓄卡超额单日
    private String note;
    ...
    public Integer getCxkExcessOne() {
        return cxkExcessOne;
    }

    public void setCxkExcessOne(Integer cxkExcessOne) {
        this.cxkExcessOne = cxkExcessOne;
    }

    public Integer getCxkExcessDay() {
        return cxkExcessDay;
    }

    public void setCxkExcessDay(Integer cxkExcessDay) {
        this.cxkExcessDay = cxkExcessDay;
    }

    public Integer getCxkExcessMonth() {
        return cxkExcessMonth;
    }

    public void setCxkExcessMonth(Integer cxkExcessMonth) {

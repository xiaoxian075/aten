...
public class CommRedisFun {
     ...
     * @return
     */
    public static Integer setKeyExpire(String key,java.util.HashMap map,Integer seconds){
        Integer state = 0;
        Jedis jedis = null;
        try{
            jedis = JedisPoolUtil.getJedis();
     ...
     * @return
     */
    public static synchronized Integer setKeyIncr(String key,long value){
        Integer state = 0;
        Jedis jedis = null;
        try{
            jedis = JedisPoolUtil.getJedis();
     ...
     * @return
     */
    public static synchronized Integer setKey(String key,String value){
        Integer state = 0;
        Jedis jedis = null;
        try{
            jedis = JedisPoolUtil.getJedis();
     ...
     * @return
     */
    public static synchronized Integer isExists(String key){
        Integer state = 0;
        Jedis jedis = null;
        try{
            jedis = JedisPoolUtil.getJedis();

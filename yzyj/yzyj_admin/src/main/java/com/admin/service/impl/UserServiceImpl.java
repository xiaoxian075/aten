...
//    }
    ...
    @Override
    public AgencyPerson getAgencyPerson(String agentUnique) {
        return userDaoMapper.getAgencyPerson(agentUnique);
    }

    @Override
    public void updateUserName(AgencyPerson agencyPerson) {
        userDaoMapper.updateUserName(agencyPerson);
    }

 ...
 */
public class DeviceList extends  CommModel{
    ...
    private String subsidyStatus;//返现状态     0：未提交 1：待审批  2：审批通过  3：不通过
    private String subsidyTime;    //返现时间
    private String tyjStatus;//退押金状态 0：未提交 1：待审批  2：审批通过  3：不通过
    private String tyjTime;//提交时间
    private String tyjNumber;//编号

    public String getTyjStatus() {
        return tyjStatus;
    }

    public void setTyjStatus(String tyjStatus) {
        this.tyjStatus = tyjStatus;
    }

    public String getTyjTime() {
        return tyjTime;
    }

    public void setTyjTime(String tyjTime) {
        this.tyjTime = tyjTime;
    }

    public String getTyjNumber() {
        return tyjNumber;
    }

    public void setTyjNumber(String tyjNumber) {
        this.tyjNumber = tyjNumber;
    }

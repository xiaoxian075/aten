...
<div class="modal-content" id="brand-content">
    ...
    <div class="modal-body">
        <form class="form-horizontal" role="form" id="editForm" method="POST" enctype="multipart/form-data" action="<%=basePath%>rest/admin/user/editRole">
            <c:choose>
            ...
            <div class="form-group" id="mcDiv">
                <div class="group">
                    ...
                    <div class="col-sm-9">
                        <input class="form-control" name="text" maxlength="50" rows="3" value="${info.username}" readonly="readonly"/>
                    </div>
                    ...
                    <div class="col-sm-9">
                        <select class="form-control" name="rid">
                            ...
                            <c:forEach items="${ls}" var="ls">
                                <option value="${ls.id}" <c:if test="${info.rid eq ls.id}"> selected</c:if>>${ls.roleName}</option>
                            </c:forEach>
                        </select>
                    </div>

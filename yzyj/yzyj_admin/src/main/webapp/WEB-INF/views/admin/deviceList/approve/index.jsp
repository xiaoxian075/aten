        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="dataTables_length" id="dataTables-example_length">
                    ...
                    <button type="button" class="btn btn-default" style="background-color:#f4f4f4;" onclick="add('${info.agentUnique}')">添加设备</button>
...
<script>
    $(function () {
        ...
        var table = $.deviceApproveList.initTables("user-table", null);
        var msg = $("#msg").val();
        if(msg != ""){
            alert(msg);
        }
    ...
    function add(deviceUnique){
        window.location="<%=basePath%>rest/admin/deviceList/editApproval?deviceUnique="+deviceUnique;
    };
    function edit(id){
        window.location="<%=basePath%>rest/admin/deviceList/editApproval?id="+id;
    };
    function reApproval(id,state){
        ...
        if (r) {
            $.ajax({
                type: "POST",
                url: "<%=basePath%>rest/admin/deviceList/editApprovalStatus",
                traditional: true,

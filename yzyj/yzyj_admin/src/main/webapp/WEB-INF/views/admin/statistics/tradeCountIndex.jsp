            ...
            <div class="box-body">
                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper" role="grid">
                    <table id="check-table" class="table table-bordered table-hover" style="overflow-y:auto; border-spacing: 0px;">
                        <thead>
                        <tr>
                            <th colspan="8" scope="col">代理设备流水表(单位：元)</th>
                        </tr>
                        <tr role="row" style="background-color: #f5f5f5;">
                            <th style="width: 30px;">代理人</th>
                            <th style="width: 30px;">云付通账号</th>
                            <th style="width: 80px;">累计刷卡总额(元)</th>
                            <th style="width: 80px;">月刷卡总额(元)</th>
                            <th style="width: 80px;">设备总台数</th>
                            <th style="width: 80px;">月新增</th>
...
<script type="text/javascript">
    $(function () {
        ...
        var table = $.tradeCount.initTables("check-table", null);
        $('#viewdetail').on('hide.bs.modal', function () {
            table.ajax.reload();
        })
    });

    function tradeDetail(agentUnique){
        window.location="<%=basePath%>rest/admin/statistics/tradeDetail?agentUnique="+agentUnique;
    };
</script>

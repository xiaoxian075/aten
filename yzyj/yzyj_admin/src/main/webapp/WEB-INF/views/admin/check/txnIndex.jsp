        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="dataTables_length" id="dataTables-example_length">
                    <label>分账日期起:</label>
                    <label>
                        <input name="sdate" id="sdate" size="15" class="form-control input-sm"  placeholder="分账日期起" type="text" onfocus="WdatePicker({ dateFmt: 'yyyyMMdd' ,maxDate:'%y-%M-{%d-1}'})" />
                    </label>
                    &nbsp;&nbsp; - &nbsp;&nbsp;
                    <label>
                        <input name="edate" id="edate" size="15" class="form-control input-sm"  placeholder="分账日期止" type="text" onfocus="WdatePicker({ dateFmt: 'yyyyMMdd' ,maxDate:'%y-%M-{%d-1}'})" />
                    </label>
                    &nbsp;&nbsp;
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="dataTables_length" id="dataTables-example_length1">
                    ...
                    &nbsp;&nbsp;
                    <button id="message-query1" type="button" class="btn btn-danger btn-xs" onclick="reloadTxn()"> 载入数据</button>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <table id="check-table" class="table table-bordered table-hover" style="overflow-y:auto; border-spacing: 0px;">
                            <thead>
                                <tr role="row" style="background-color: #f5f5f5;">
                                    ...
                                    <th style="width: 160px;">分账日期</th>
                                    <th style="width: 100px;">虚拟账户余额</th>
                                    <th style="width: 110px;">交易笔数</th>
                                    <th style="width: 150px;">交易总金额</th>
                                    <th style="width: 300px;">入账总金额</th>
                                    <th style="width: 100px;">手续费</th>
                                    <th style="width: 110px;">备付金余额</th>
...
<script>
    $(function () {
        ...
        var table = $.TxnRecord.initTables("check-table", null);
    ...
    function reloadTxn(){
        ...
        if (r) {
            $.ajax({
                type: "POST",
                url: "<%=basePath%>rest/admin/lklBill/reloadTxn",
                traditional: true,

...
<script type="text/javascript" src="<%=basePath%>ueditor/1.4.3/ueditor.config.js"></script>
<script type="text/javascript" src="<%=basePath%>ueditor/1.4.3/ueditor.all.min.js"> </script>
<script type="text/javascript" src="<%=basePath%>ueditor/1.4.3/lang/zh-cn/zh-cn.js"></script>
<script type="text/javascript" src="<%=basePath%>ueditor/1.4.3/lang/en/en.js"></script>

<script type="text/javascript" src="<%=basePath%>js/load/jquery-ui-jqLoding.js"></script>
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="dataTables_length" id="dataTables-example_length">
                        <label>
                            <input type="search" class="form-control input-sm" placeholder="姓名、电话、地址" aria-controls="dataTables-example" name="queryBody" id="queryBody" value=""/>
                        </label>
...
<script>
    $(function () {
        ...
        var table = $.Account.initTables("check-table", null);

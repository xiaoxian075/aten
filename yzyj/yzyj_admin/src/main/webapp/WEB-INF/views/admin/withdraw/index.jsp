        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="dataTables_length" id="dataTables-example_length">
                        <label>提现人:</label>
                        <label>
                            <input type="search" class="form-control input-sm" placeholder="姓名、电话、地址" aria-controls="dataTables-example" name="agencyname" value=""/>
                        </label>
                        <label>云付通账号:</label>
                        <label>
...
<script>
    $(function () {
        ...
        var table = $.WithdrawRecord.initTables("check-table", null);

    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="dataTables_length" id="dataTables-example_length1">
                ...
                <label>时间:</label>
                <label>
                    <select class="form-control" name="queryTime" id="queryTime">
...
<div class="row">
    <div class="col-xs-12">
        <h4>代理未提现总额:<span style="color: red">${remainingSum}</span>元</h4>
    </div>
</div>
                ...
                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper" role="grid">
                    <table id="check-table" class="table table-bordered table-hover" style="overflow-y:auto; border-spacing: 0px;">
                        ...
                        <tr role="row" style="background-color: #f5f5f5;">
                            ...
                            <th style="width: 80px;">未提现</th>
                            <th style="width: 80px;">历史总额</th>
                            <th style="width: 80px;">天收益</th>
                            <th style="width: 80px;">月收益</th>
                        </tr>
                        </thead>
...
<script type="text/javascript">
    $(document).ready(function(){
        $("#month").hide();
        $("#queryTime").bind("change",function(){
...
<script>
    $(function () {
        ...
        var table = $.agentStatistics.initTables("check-table", null);

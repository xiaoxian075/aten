    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="dataTables_length" id="dataTables-example_length">
                ...
                <label>商家云付通账号:</label>
                <label>
                    <input type="search" class="form-control input-sm" placeholder="商家云付通账号" aria-controls="dataTables-example" name="merchantYunPayAccount" value=""/>
                </label>
                <label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                <label>代理人:</label>
                <label>
                ...
                <label>返现:</label>
                <label>
                    <select class="form-control input-sm" name="subsidyStatus">
                        <option value="" selected="selected">请选择</option>
...
<script>
    $(function () {
        ...
        var table = $.deviceAlLeadList.initTables("user-table", null);
    ...
    function submitSubsidy(id,agentUnique){
        var r = confirm("确认提交设备返现?");
        if (r) {
            $.ajax({
                type: "POST",
                url: "<%=basePath%>rest/admin/deviceList/submitSubsidy",
                traditional: true,
